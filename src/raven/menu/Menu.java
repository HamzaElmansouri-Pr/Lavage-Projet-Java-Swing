...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"},
        {"Employes", "Ajouter Employe", "Modifier Employe"},
        {"Clients","Ajouter Client","Modifier Client"},
        {"Booking","Ajouter Booking","Naviguer Booking"},
    ...
    private final String headerName = "Lavage Andalousse";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/raven/icon/png/logoo.png")));
